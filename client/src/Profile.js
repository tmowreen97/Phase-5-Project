      ...
      <div className="user-info">
        ...
        <div className="user-experiences">
          ...
          user.experiences.map((experience)=> {
            return( <li title="Click to navigate to category" onClick={()=> navigate(`/category/${experience.category_id}`)}className="user-experiences-list">{experience.comment} -{experience.category}</li>)
          })}
        </div>
      </div>
    </div>
